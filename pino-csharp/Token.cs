...
public enum OperatorType {
  ...
  LessThan, LessThanEqual, GreaterThan, GreaterThanEqual, Equal, NotEqual, IdentityEqual, IdentityNotEqual, And, Or, Not, MemberAccess, StaticMemberAccess, Arrow, In, NotIn, QuestionMark
}
